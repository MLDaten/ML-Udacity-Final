...
def train(model, loss_criterion, use_cuda, train_loader, optimizer, epoch, hook):
...
def main(args):
    ...
    for epoch in range(1, args.epochs + 1):
        train(model, loss_criterion, args.gpu, train_loader, optimizer, epoch, hook)
        test(model, loss_criterion, args.gpu, test_loader, hook)
